...
public class PermissionUtil {
    ...
    public static void getPermission(Activity activity){
        PermissionUtil.justGetpermission(activity,Manifest.permission.WRITE_EXTERNAL_STORAGE,2);
        PermissionUtil.justGetpermission(activity, Manifest.permission.MOUNT_UNMOUNT_FILESYSTEMS,1);
        PermissionUtil.justGetpermission(activity,Manifest.permission.READ_EXTERNAL_STORAGE,3);

    }


    public static void verifyStoragePermissions(Activity activity){
        int permisson =ActivityCompat.checkSelfPermission(activity
